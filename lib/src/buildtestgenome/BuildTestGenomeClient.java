...
public class BuildTestGenomeClient {
    ...
    public String prepareTestGenomeFromProteins(PrepareTestGenomeFromProteinsParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<String> res = caller.jsonrpcCall("BuildTestGenome.prepare_test_genome_from_proteins", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("BuildTestGenome.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
