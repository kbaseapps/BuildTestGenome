...
function BuildTestGenome(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.prepare_test_genome_from_proteins = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "BuildTestGenome.prepare_test_genome_from_proteins",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "BuildTestGenome.status",
